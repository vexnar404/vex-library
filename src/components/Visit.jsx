    ...
    <section id="visit" className="py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d3501.9812653243125!2d77.21273341984238!3d28.630323589681534!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1759905212896!5m2!1sen!2sin" width="600" height="450" style={{border:0}} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
          </div>
          ...
          <div className="contact-info">
            ...
            <p className="mb-4 text-lg">
              ...
              1st Floor,Building 2, Arya School Lane, Connaught Place, New Delhi, Delhi, 110001
            </p>
            <p className="mb-4 text-lg">
