      ...
      <div className="container mx-auto">
        <div className='flex flex-col sm:flex-row items-center justify-center mx-3 lg:mx-20'>
          ...
          <div className='md:ml-30 sm:px-4 text-lg'>
            ...
            <p>
              <span className='font-semibold'>That's exactly why we built Vex's Library,</span> to give you the <span className='text-orange-700'>perfect atmosphere for deep focus.</span>
            </p>
            <p>
